...
class RegistrationPage(BasePage):
    def __init__(self, page: Page):
        ...
        self.registration_page_registration_button = page.get_by_test_id('registration-page-registration-button')
    ...
    def fill_registration_form(self, email: str, username: str, password: str) -> None:
        ...
        expect(self.registration_form_username_input).to_have_value(username)
    ...
    def click_registration_button(self) -> None:
        self.registration_page_registration_button.click()
